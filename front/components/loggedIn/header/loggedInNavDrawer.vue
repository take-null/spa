  ...
  >
    <template v-if="mini === true">
      <b-container class="d-flex justify-content-end">
        <v-btn icon outrined rounded @click.stop="closeDrawerChild">
    ...
    <template v-else>
      <b-container class="d-flex justify-content-end">
        <v-btn icon outrined rounded @click.stop="mini = !mini">
          <v-icon> mdi-chevron-left </v-icon>
        </v-btn>
      </b-container>
    </template>
    <template v-if="img === null">
      <v-list-item class="px-2">
        <v-list-item-avatar size="45">
          <v-btn icon outlined rounded @click.stop="mini = !mini">
