<template>
  <v-sheet>
    <v-app-bar app dense elevation="1" clipped-left dark>
      ...
      <v-btn icon @click.prevent="moveChatPage()">
      ...
      <template v-else>
        <v-menu app offset-x offset-y max-width="1000">
                ...
                >
                  <v-card-actions>
                    <v-container v-if="notice.user_image === ''">
                      <v-row>
                        <v-col cols="2">
                          <v-btn icon @click="showUser(notice.visitor_id)">
                            <v-avatar size="40">
                        ...
                        <v-col cols="1">
                          <v-btn icon x-small @click="deleteNotice(notice.id)">
                        ...
                        <v-col cols="2">
                          <v-btn icon @click="showUser(notice.visitor_id)">
                            <v-avatar size="40" class="user-image">
                              <v-img :src="notice.user_image" alt="avatar" />
                            </v-avatar>
                          </v-btn>
                        </v-col>
                        <v-col cols="9">
...
export default {
  ...
  methods: {
    ...
    async deleteNotice(id) {
      await this.$axios.$delete(`/api/v1/notifications/${id}`).then((res) => {
