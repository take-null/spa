    ...
    <v-main>
      ...
      >
        ...
        <v-tabs v-model="tab" grow>
          <v-tab v-for="friend in friends" :key="friend">
            {{ friend }}
          </v-tab>
        </v-tabs>
                      ...
                      <v-list-item :key="item.id">
                        ...
                        <v-list-item-content two-line>
                          ...
                          <v-list-item-subtitle>
                            <template v-if="item.profile === null">
                              こんにちは！
                            </template>
                            <template v-else class="text-sm-h6 mb-4">
                              {{ item.profile }}
                            </template>
                          </v-list-item-subtitle>
                        </v-list-item-content>
...
export default {
  ...
  data() {
    return {
      ...
      fls: [
        { title: 'following', change: false },
        { title: 'followers', change: true },
      ],
    }
  },
  methods: {
